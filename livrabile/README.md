...
| Fișier | Descriere |
|--------|-----------|
| `business-plan.pdf` | Plan de afaceri în forma oficială trimisă la juriu (PDF, 1 pagină — formatul cerut de regulament). |
| `business-plan.md` | Aceeași informație în Markdown, păstrată ca sursă editabilă. |
